...
export const ADVANTAGE_POOL: Advantage[] = [
  ...
  { id: "queens_domain", name: "Queen’s Domain", description: "Your queen may pass through friendly pieces once per game.", rarity: "common" }, // done
  ...
  { id: "recall", name: "Recall", description: "Teleport any piece to its position 3 turns ago, once.", rarity: "rare" }, // done
