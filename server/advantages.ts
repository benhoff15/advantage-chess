...
export const ADVANTAGE_POOL: Advantage[] = [
  ...
  { id: "restless_king", name: "Restless King", description: "If your king moves, your opponent cannot give check on their next turn.", rarity: "common" },
  { id: "superstitious_knight", name: "Superstitious Knight", description: "Once per knight, if it moves to a square it previously visited, it may move again immediately.", rarity: "common" },
  { id: "queens_domain", name: "Queen’s Domain", description: "Your queen may pass through friendly pieces once per game.", rarity: "common", serverValidation: validateQueensDomainServerMove },
  ...
  { id: "no_show_bishop", name: "No-Show Bishop", description: "Leave one bishop off the board. You may summon it to any empty square before turn 10.", rarity: "rare" },
  { id: "ethereal_gambit", name: "Ethereal Gambit", description: "Start with an extra bishop placed randomly.", rarity: "rare" },
